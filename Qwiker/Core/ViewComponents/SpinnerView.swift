...
struct Spinner: View {
    ...
    var body: some View {
        ZStack {
            ...
            ZStack {
                // S1
                SpinnerCircle(start: spinnerStart, end: spinnerEndS1, rotation: rotationDegreeS1, color: .secondaryGrey.opacity(0.5), lineWidth: lineWidth)
                // S3
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS3, color: .primaryBlue, lineWidth: lineWidth)

                // S2
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS2, color: .primaryBlue, lineWidth: lineWidth)
